...
class Repository implements IRepository {
        ...
        if (game.getGameId() == null) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    rs.updateInt(GAME_CURRENTPLAYER,  game.getPlayerNumber(game.getCurrentPlayer()));//game.getPlayerNumber(game.getCurrentPlayer())
                    rs.updateRow();


                } else {
                    ErrorHandling("Resultset er tom nu");
    ...
    public Board loadGameFromDB(int id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                Board boardTemplate = gson.fromJson(rs.getString("roborally"), Board.class);
    ...
    private void createPlayersInDB(Board game) throws SQLException {
        ...
        for (int i = 0; i < game.getPlayersNumber(); i++) {
            ...
            ps1.setInt(1, player.getDBNumber());
            ...
            ps2.setInt(1, player.getDBNumber());
    ...
    private void ErrorHandling(String ErrorHandling) {
        Alert alert = new Alert(Alert.AlertType.ERROR, ErrorHandling);
        alert.showAndWait();
    }
